...
model = joblib.load(path_to_artifacts + "models/FDTree.joblib")
wi_fn = joblib.load(path_to_artifacts + "models/wi_fn.joblib")
wi_ln = joblib.load(path_to_artifacts + "models/wi_ln.joblib")

def get_lookup_input():
    first_name = NameForm.fname
    last_name = NameForm.lname
    dob = NameForm.dob
